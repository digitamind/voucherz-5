...
public class VoucherMailDistributionSubscriber implements MessageListener {
    private static final Logger logger = LoggerFactory.getLogger(VoucherMailDistributionSubscriber.class);
    private EmailService emailService;

    public VoucherMailDistributionSubscriber(EmailService emailService){
