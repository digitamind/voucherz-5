...
class VoucherForm extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
        <form className={classes.container} autoComplete="off" onSubmit={this.props.handleSubmitVoucherVal}>
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        onChange={this.props.handleChange("toggle")}
                        // checked="false"
                        classes={{
                    ...
                    label="Slide to set Active or Inactive"
                  />
                </div>
                </GridItem>
                <GridItem xs={12} sm={12} md={3}>
...
export default withStyles(VoucherFormStyle)(VoucherForm);
