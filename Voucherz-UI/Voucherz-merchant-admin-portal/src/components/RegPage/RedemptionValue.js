...
class RedemptionValue extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onSubmit = (e) => {
    ...
    axios.post(`${APIBASEURL}/value-voucher-service/${code}/redeem`)
    .then((res)=>{
...
export default withStyles(loginPageStyle)(RedemptionValue);
